...
fn dynamic_types_are_split_into_focused_modules() {
    ...
    for relative in [
        ...
        "src/core/dynamic/dyn_ad_tensor/accessors.rs",
        "src/core/dynamic/dyn_ad_tensor/basics.rs",
        "src/core/dynamic/dyn_ad_tensor/complex.rs",
        "src/core/dynamic/dyn_ad_tensor/debug.rs",
        "src/core/dynamic/dyn_ad_tensor/downcast.rs",
        "src/core/dynamic/dyn_ad_tensor/layout.rs",
        "src/core/dynamic/dyn_ad_tensor/layout/structured.rs",
        "src/core/dynamic/dyn_ad_tensor/merge.rs",
        "src/core/dynamic/dyn_ad_tensor/eager_linalg/mod.rs",
        "src/core/dynamic/dyn_ad_tensor/eager_linalg/extra.rs",
        "src/core/dynamic/dyn_ad_tensor/eager_linalg/extra_tensorized.rs",
        "src/core/dynamic/dyn_ad_tensor/eager_linalg/results.rs",
        "src/core/dynamic/dyn_ad_tensor/eager_scalar.rs",
        "src/core/dynamic/dyn_ad_tensor/eager_tensor.rs",
        "src/core/dynamic/dyn_ad_tensor/placement.rs",
        ...
        "src/core/dynamic/dyn_ad_tensor/shape.rs",
        "src/core/dynamic/dyn_ad_tensor/snapshot.rs",
        "src/core/dynamic/tests/mod.rs",
        "src/core/dynamic/tests/organization.rs",
        "src/core/dynamic/tests/placement.rs",
        "src/core/dynamic/tests/scalar_type.rs",
    ] {
        assert!(
