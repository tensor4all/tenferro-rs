//! Faer-backed CPU implementation of tensor linalg operations.
//!
//! This module implements tensor-level linalg operations by delegating to
//! the existing slice-based `FaerBackend`. Slices are used only as an
