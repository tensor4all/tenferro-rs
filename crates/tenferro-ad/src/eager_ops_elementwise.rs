...
impl EagerTensor {
    ...
    /// let y = x.sign().unwrap();
    ///
    /// assert_eq!(y.value().unwrap().as_slice::<f64>().unwrap(), &[-1.0, 1.0]);
    /// # Ok::<(), tenferro_ad::Error>(())
    /// ```
    /// # Errors
    ///
    ...
    /// let y = x.log().unwrap();
    ///
    /// assert_eq!(y.value().unwrap().as_slice::<f64>().unwrap(), &[0.0]);
    /// # Ok::<(), tenferro_ad::Error>(())
    /// ```
    /// # Errors
    ///
    ...
    ///
    /// assert_eq!(y.value().unwrap().as_slice::<f64>().unwrap(), &[0.5]);
    /// # Ok::<(), tenferro_ad::Error>(())
    /// ```
    /// # Errors
    ///
    ...
    ///
    /// assert_eq!(z.value().unwrap().as_slice::<f64>().unwrap(), &[4.0, -2.0, 3.0]);
    /// # Ok::<(), tenferro_ad::Error>(())
    /// ```
    /// # Errors
    ///
    ...
    ///
    /// assert_eq!(y.value().unwrap().as_slice::<f64>().unwrap(), &[8.0, 9.0]);
    /// # Ok::<(), tenferro_ad::Error>(())
    /// ```
    /// # Errors
    ///
    ...
    ///
    /// assert_eq!(z.value().unwrap().as_slice::<f64>().unwrap(), &[3.0, 5.0]);
    /// # Ok::<(), tenferro_ad::Error>(())
    /// ```
    /// # Errors
    ///
    ...
    ///
    /// assert_eq!(z.value().unwrap().as_slice::<f64>().unwrap(), &[1.0, 4.0]);
    /// # Ok::<(), tenferro_ad::Error>(())
    /// ```
    /// # Errors
    ///
    ...
    ///
    /// assert_eq!(y.value().unwrap().as_slice::<f64>().unwrap(), &[1.0, 20.0]);
    /// # Ok::<(), tenferro_ad::Error>(())
    /// ```
    /// # Errors
    ///
    ...
    ///
    /// assert_eq!(y.value().unwrap().as_slice::<f64>().unwrap(), &[-1.0, 0.5, 4.0]);
    /// # Ok::<(), tenferro_ad::Error>(())
    /// ```
    /// # Errors
    ///
