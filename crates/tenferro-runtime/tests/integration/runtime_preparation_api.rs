...
use tenferro_runtime::{
    ...
    IndexingRuntime, LayoutRuntime, PreparedOperation, PreparedOperationExecutor,
    PreparedOperationExecutorHandle, PreparedOperationHandle, PreparedOperationPlan,
    ReductionRuntime, Runtime, RuntimeConfigBuilder, RuntimeConfigSnapshot, RuntimeReconfiguration,
    UnsupportedReason,
};
...
fn prepared_operation_has_bounded_execution_contract() {
    ...
    fn takes_prepared_executor(_: Option<&dyn PreparedOperationExecutor>) {}
    fn takes_prepared_executor_handle(_: Option<&PreparedOperationExecutorHandle>) {}
    fn takes_prepared_plan(_: Option<&PreparedOperationPlan>) {}
    ...
    let _ = (
        ...
        takes_prepared_executor,
        takes_prepared_executor_handle,
        takes_prepared_plan,
        takes_core_traits,
    ...
    let trait_body = source
        ...
        .map(|(body, _)| body)
        .expect("PreparedOperation trait should precede executor bridge");
