...
use crate::{
    ...
    LapackEigScalar, LinalgCapabilityOp, LuTensorExResult, LuTensorResult, QrTensorResult,
    SolveTensorExResult, SvdTensorResult, TensorLinalgPrims,
};
...
mod private {
    ...
    pub trait CpuLinalgOps: KernelLinalgScalar + LapackEigScalar {
        fn solve_slices(
            a: &[Self],
            b: &[Self],
            n: usize,
...
///
/// ```ignore
/// let _backend = tenferro_linalg_prims::backend::CpuTensorLinalgBackend;
/// ```
