...
pub fn pullback<T: Scalar + 'static>(
    ...
    tape::pullback(tape, output_node, &cotangent_payload)
}
...
pub fn pullback_wrt_mixed<TOut: Scalar + 'static, TWrt: Scalar + 'static>(
    ...
    let grads =
        tape::pullback_wrt_mixed::<TOut, TWrt>(tape, output_node, &cotangent_payload, &wrt_nodes)?;
...
pub fn pullback_wrt_scalars<TOut: Scalar + 'static, TWrt: ScalarAd + 'static>(
    ...
    tape::pullback_wrt_scalars::<TOut, TWrt>(tape, output_node, &cotangent_payload, &wrt_nodes)
}
