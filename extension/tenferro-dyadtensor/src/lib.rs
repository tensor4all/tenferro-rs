...
pub use api::{
    add_ad, cholesky, cholesky_ad, det, det_ad, eig, eig_ad, eigen, eigen_ad, einsum, einsum_ad,
    exp_ad, inv, inv_ad, lstsq, lstsq_ad, lu, lu_ad, matrix_exp, matrix_exp_ad, mean_ad, norm,
    norm_ad, pinv, pinv_ad, qr, qr_ad, slogdet, slogdet_ad, solve, solve_ad, solve_triangular,
    solve_triangular_ad, sum_ad, svd, svd_ad, AdEigResult, AdEigenResult, AdLstsqResult,
