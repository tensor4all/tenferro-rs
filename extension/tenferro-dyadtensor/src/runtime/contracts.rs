...
///
/// ```ignore
/// fn require_einsum<T: tenferro_dyadtensor::runtime::contracts::EinsumRuntimeValue>() {}
/// require_einsum::<f64>();
/// ```
...
///
/// ```ignore
/// fn require_scalar<T: tenferro_dyadtensor::runtime::contracts::ScalarRuntimeValue>() {}
/// require_scalar::<f64>();
/// ```
...
///
/// ```ignore
/// fn require_analytic<T: tenferro_dyadtensor::runtime::contracts::AnalyticRuntimeValue>() {}
...
///
/// ```ignore
/// fn require_all<T: tenferro_dyadtensor::runtime::contracts::ScalarAnalyticRuntimeValue>() {}
/// require_all::<f64>();
/// ```
...
///
/// ```ignore
/// fn require_generic_ad<T: tenferro_dyadtensor::runtime::contracts::GenericAdRuntimeValue>() {}
...
///
/// ```ignore
/// fn require_real_ad<T: tenferro_dyadtensor::runtime::contracts::RealAdRuntimeValue>() {}
/// require_real_ad::<f64>();
/// ```
...
///
/// ```ignore
/// fn require_linalg<T: tenferro_dyadtensor::runtime::contracts::LinalgRuntimeValue>() {}
/// require_linalg::<f64>();
/// ```
...
///
/// ```ignore
/// fn require_real_linalg<T: tenferro_dyadtensor::runtime::contracts::RealLinalgRuntimeValue>() {}
...
///
/// ```ignore
/// fn require_complex_linalg<T: tenferro_dyadtensor::runtime::contracts::ComplexLinalgRuntimeValue>() {}
