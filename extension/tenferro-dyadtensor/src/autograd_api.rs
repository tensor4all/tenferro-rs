...
///
/// ```rust
/// use tenferro_dyadtensor::BackwardOptions;
///
...
///
/// ```rust
/// use tenferro_dyadtensor::GradOptions;
///
...
///
/// ```rust
/// use tenferro_dyadtensor::{grad, set_default_runtime, GradOptions, RuntimeContext, Tensor};
