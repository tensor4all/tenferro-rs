...
pub fn plan_axis_classes_for_subscripts(
    ...
    // Step 1a: union logical axes in the same local class.
    ...
    // Step 1b: union explicit equal-label axes across operands.
    ...
    // Step 3: per-operand plans (detect duplicate roots after global merge).
    ...
    // Step 4/5: output roots and restored output axis classes.
