...
impl DynAdScalar {
    ...
    pub fn real_part(&self) -> Self {
        match self.clone() {
            Self::F32(v) => Self::F32(v),
            Self::F64(v) => Self::F64(v),
            Self::C32(v) => Self::F32(crate::core::value::map_ad_value_mixed_linear(
                v,
                |z| z.re,
                |cotangent| Complex32::new(cotangent, 0.0),
            )),
            Self::C64(v) => Self::F64(crate::core::value::map_ad_value_mixed_linear(
                v,
                |z| z.re,
    ...
    pub fn imag_part(&self) -> Self {
        match self.clone() {
            Self::F32(v) => Self::F32(crate::core::value::map_ad_value_same_type_linear(v, |_| {
                0.0_f32
            })),
            Self::F64(v) => Self::F64(crate::core::value::map_ad_value_same_type_linear(v, |_| {
                0.0_f64
            })),
            Self::C32(v) => Self::F32(crate::core::value::map_ad_value_mixed_linear(
                v,
