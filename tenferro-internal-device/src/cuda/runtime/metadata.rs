...
impl CudaRuntime {
    ...
    /// unsafe {
    ///     runtime.metadata_reduce_sum_i32(input, 4, dst, 2, &[2, 2], &[1, 2], 0, &[2], &[1], 0, &[0], &[1]).unwrap();
    ...
    /// let dst = runtime.alloc_raw::<i32>(2).unwrap();
    /// unsafe {
    ///     runtime.metadata_reduce_sum_bool(input, 4, dst, 2, &[2, 2], &[1, 2], 0, &[2], &[1], 0, &[0], &[1]).unwrap();
    ///     runtime.free_raw(input).unwrap();
    ///     runtime.free_raw(dst).unwrap();
    /// }
    /// ```
    ...
    /// unsafe {
    ///     runtime.metadata_reduce_all_bool(input, 4, dst, 2, &[2, 2], &[1, 2], 0, &[2], &[1], 0, &[0], &[1]).unwrap();
    ///     runtime.free_raw(input).unwrap();
    ///     runtime.free_raw(dst).unwrap();
    /// }
    /// ```
    ...
    /// let dst = runtime.alloc_raw::<u8>(2).unwrap();
    /// unsafe {
    ///     runtime.metadata_reduce_any_bool(input, 4, dst, 2, &[2, 2], &[1, 2], 0, &[2], &[1], 0, &[0], &[1]).unwrap();
    ///     runtime.free_raw(input).unwrap();
    ///     runtime.free_raw(dst).unwrap();
    /// }
    /// ```
