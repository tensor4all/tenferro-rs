...
| 5 | Common `ScheduledGraph`, core transfer/collective node boundary, event domains, buffer planning, admission, and runtime-owned `Runtime::run_compiled` execution | Phases 2 and 4 | Complete on the current main line |
