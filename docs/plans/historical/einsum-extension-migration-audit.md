...
| Rule ownership | `ad_rules()` | explicit `SemanticExtensionRuleSet` helper, gated by `autodiff` | `rg -n "pub fn ad_rules|SemanticExtensionRuleSet" crates/tenferro-einsum/src` | done |
