...
See the [ecosystem overview](https://github.com/tensor4all/tenferro-rs/blob/main/docs/design/tenferro_unified_tensor_backend.md)
for high-level architecture and future phase plans.

## Crates

### [tenferro-device](tenferro_device/index.html)
...
### [tenferro-algebra](tenferro_algebra/index.html)
...
### [tenferro-prims](tenferro_prims/index.html)
...
### [tenferro-tensor](tenferro_tensor/index.html)
...
### [chainrules-core](chainrules_core/index.html)
...
### [chainrules](chainrules/index.html)
...
### [tenferro-einsum](tenferro_einsum/index.html)
...
### [tenferro-linalg](tenferro_linalg/index.html)
...
### [tenferro-capi](tenferro_capi/index.html)
